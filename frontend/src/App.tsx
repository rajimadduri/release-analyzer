    ...
    <div className="p-8 max-w-6xl mx-auto">
      ...
      {metrics && (
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
            ...
            <p className="text-3xl font-bold mt-2 text-green-600">{(metrics.on_time_rate * 100).toFixed(0)}%</p>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-orange-500">
            ...
            <p className={`text-3xl font-bold mt-2 ${getRiskColor(metrics.avg_risk_score)}`}>
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-red-500">
            ...
            <p className="text-3xl font-bold mt-2">{(metrics.rollback_rate * 100).toFixed(2)}%</p>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        ...
        <ol className="space-y-2 text-blue-800">
          <li>1. Go to the <strong>Release Analyzer</strong> tab</li>
          <li>2. Paste release notes and set test coverage</li>
          <li>3. Click <strong>Analyze Release</strong></li>
          <li>4. Claude API analyzes the release in real-time and predicts deployment risk</li>
        </ol>
      </div>
    </div>
  );
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <p className="text-gray-600 mb-8">
        Upload your release details and get AI-powered risk analysis powered by Claude
      </p>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <ul className="space-y-2 text-sm text-blue-800">
              <li>
                <strong>0-1 (Very Safe):</strong> Minimal risk. Deploy with standard procedures.
              </li>
              <li>
                <strong>1-2 (Safe):</strong> Low risk. Routine deployment process appropriate.
              </li>
              <li>
                <strong>2-3 (Moderate):</strong> Some risk. Recommend extra monitoring and gradual rollout.
              </li>
              <li>
                <strong>3-4 (High Risk):</strong> Significant risk. Consider delaying or adding more testing.
              </li>
              <li>
                <strong>4-5 (Critical):</strong> Do not ship. Address risk factors before deployment.
              </li>
            </ul>
          </div>
        </div>
...
export default function App() {
  const [currentPage, setCurrentPage] = useState<'dashboard' | 'analyzer'>('dashboard');
